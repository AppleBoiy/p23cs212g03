...
const main = () => {
  const spreadsheetUrl =
    "https://docs.google.com/spreadsheets/d/1t8dvUUdvOxdiKQv5nagGaHyiw3P-C2o0Qg6C_1Tlq58/edit?usp=sharing";
...
function getNodeAncestors(abbreviation) {
  const parents = courseData[abbreviation]?.parent.map((e) =>
    convertCourseId(e),
  );
...
function highlightRectangle(abbreviation, mode = "") {
  ...
  const { highlightFill, highlightStroke, originalFill, originalStroke } =
    rectData;
